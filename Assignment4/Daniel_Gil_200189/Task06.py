...
g.add((ontology.Proffesor,RDF.type, RDFS.Class))
g.add((ontology.Proffesor, RDFS.label, Literal('Proffesor', datatype=XSD.string)))
...
g.add((person.Oscar, VCARD.Given,  Literal("Oscar")))
g.add((person.Oscar, VCARD.Family, Literal("Perez")))        
g.add((person.Oscar, FOAF.email,   Literal("oscar@example.org")))
