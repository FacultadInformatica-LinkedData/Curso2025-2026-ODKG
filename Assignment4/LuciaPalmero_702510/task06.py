...
Original file is located at
    https://colab.research.google.com/drive/1dPpXUjEFQ4-ZX-4LkGmJmNwmC9O3VWDy
...
#teacher corrections:
#->"http://oeg.fi.upm.es/def/people#" for "ontology"
#->"http://oeg.fi.upm.es/resource/person/" for "person"

g.namespace_manager.bind('ontology', Namespace("http://oeg.fi.upm.es/def/people#"), override=False)
g.namespace_manager.bind('person', Namespace("http://oeg.fi.upm.es/resource/person/"), override=False)
...
# TO DO
#ontology as we are dealing with vocabulary
...
# TO DO. only properties will be defined
ontology=Namespace("http://oeg.fi.upm.es/def/people#")
person=Namespace("http://oeg.fi.upm.es/resource/person/")
...
g.add((ontology.hasColleague, RDFS.range, ontology.Person)) #linked to ontologies
...
g.add((person.Oscar, ontology.hasCollegue, person.Asun))
...
g.add((person.Asun, ontology.hasCollegue, person.Raul))
