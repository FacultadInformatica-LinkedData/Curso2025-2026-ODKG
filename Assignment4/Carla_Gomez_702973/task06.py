...
Original file is located at
    https://colab.research.google.com/drive/1lov89P6kuz31SByGEydwHwfxFYYyKFvF
...
g.add((ontology.hasColleage, RDF.type, RDF.Property))
g.add((ontology.hasColleage, RDFS.label, Literal("hasColleague", datatype = XSD.string)))
g.add((ontology.hasColleage, RDFS.domain, ontology.Person))
g.add((ontology.hasColleage, RDFS.range, ontology.Person))
...
#I parse the graph to avoid defining the properties of example4 manually:
g.parse("https://raw.githubusercontent.com/FacultadInformatica-LinkedData/Curso2025-2026/master/Assignment4/course_materials/rdf/example4.rdf", format="xml")


#not sure about the error that comes up:
g.add((person.Oscar, FOAF.email, Literal("O.garciacorcho@example.org")))
